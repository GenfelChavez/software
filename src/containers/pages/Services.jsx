...
import coding_img from 'assets/img/services/codigo.png'
...
// agrega nuevas secciones en la vista de servicios con su imagen correspondiente importada haciendo llamado desde el src/img/service/nombre.png
const post_design = [
    {
      title: 'Boost your conversion rate',
      href: '#',
...
useEffect(()=>{
    ...
    return(
        <Layout>
           <Helmet>
                   <title>Zona Software S.R.L. | Servicios </title>
            ...
            <div className='pt-28' >
                ...
                <ServicesList posts= {posts_software} section_title={'Software Development Services'}/>
