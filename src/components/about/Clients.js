          ...
          <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
            <div>
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Soluciones en casos reales
              </h2>
              <p className="mt-3 max-w-3xl text-lg text-gray-500">
                  Nos enfocamos en ofrecer soluciones tecnológicas que impulsan la innovación y mejoran la eficiencia de las empresas.
                  Creemos en el trabajo colaborativo y en la búsqueda constante de la excelencia en cada proyecto.
              </p>
            ...
            <div className="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
              ...
              <div className="col-span-1 flex justify-center bg-gray-50 py-8 px-8">
                <img className="max-h-12" src="google.png" alt="Mirage" />
              </div>
              <div className="col-span-1 flex justify-center bg-gray-50 py-8 px-8">
