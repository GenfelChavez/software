...
import {useState,Fragment,usefEffect} from 'react';
...
function Navbar() {
  ...
  return (
    <nav id='navbar' className="w-full py-6 top-0 bg-black shadow-xl transition duration-300 ease-in-out  z-40 fixed">
